...
| 1.3 | 06/04/2026 | Correções na modelagem BPMN (fluxos), ajuste da duração do Design Sprint e revisão da documentação | Ana Carolina Fialho | Raissa Silva |
| 1.4 | 06/04/2026 | Revisão do documento | Gabriel Pinto | Maria Samara |
