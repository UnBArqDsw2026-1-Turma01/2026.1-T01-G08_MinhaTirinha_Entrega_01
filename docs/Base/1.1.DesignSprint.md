...
A validação buscou verificar se os usuários são capazes de:
...
2. Público-Alvo
A validação foi realizada com usuários que:
...
4. Metodologia
O teste foi conduzido de forma moderada, com acompanhamento de um facilitador.

Durante a execução:
- Os participantes foram incentivados a pensar em voz alta
- Não houve interferência do facilitador durante as tarefas
- Foram observadas dificuldades, erros e comportamentos dos usuários
...
| 1.3 | 06/04/2026 | Refatoração da explicação do Digrama de Ishikawa | Guilherme Flyan | - |
...
| 1.3 | 05/04/2026 | Adição das estimativas do projeto | João Marcelo | — |
| 1.4 | 06/04/2026 | Adição da validação do protótipo | Gabriel Santos, Maria Samara e Marjorie Mitzi| Ana Carolina Fialho |
| 1.5 | 06/04/2026 | Formatando imagens do Rich Picture | Gabriel Santos | Guilherme Flyan |
